		...
		if($_SERVER["REQUEST_METHOD"]=="POST")
		{
			...
			if($idtran>0)
			{
				...
				try {
				    ...
				    $mail->Body    = "Xin chào " .$user['name']. " !<br> Chúng tôi đã nhận được đơn hàng của bạn, nhân viên sẽ sớm gọi lại để xác nhận đơn hàng. <br> Mọi thắc mắc vui lòng gọi đến hotline 01656019595, xin cám ơn !";
