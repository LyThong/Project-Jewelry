            ...
            <div class="container">
               <div class="col-md-3  fixside" >
                  <div class="box-left box-menu">
                     <h3 class="box-title"><i class="fa fa-gift"></i>  Sản phẩm mới </h3>
                     <ul>
                        <?php foreach ($productNew as $item): ?>
                           ...
                           <a href="chi-tiet-san-pham.php?id=<?php echo $item['id']?>">
                              ...
                              <div class="info pull-right">
                                 ...
                                 <b class="price">Giảm giá: <?php echo formartpricesale($item['price'],$item['sale']) ?></b><br>
                                 <b class="sale">Giá gốc: <?php echo formartPrice($item['price']) ?></b><br>
                  ...
                  <div class="box-left box-menu">
                     <h3 class="box-title"><i class="fa fa-gift"></i>  Sản phẩm bán chạy </h3>
